...
const supportingVisuals: SupportingVisual[] = [
  {
    ...
    summary:
      "Garden courts and quieter internal walkways soften the estate’s apartment setting.",
    src: "/images/inspiration/garden-walkway.jpg",
    alt: "Landscaped residential courtyard setting.",
  },
  {
    ...
    <section className="hero-space">
      <div className="page-shell">
        <div className="grid items-stretch gap-5 xl:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
          <article className="order-2 soft-card surface-feature radius-feature overflow-hidden p-3 xl:order-1">
            <div className="radius-panel relative min-h-[23rem] overflow-hidden sm:min-h-[30rem] xl:min-h-[46rem]">
              <Image
          ...
          <div className="order-1 grid gap-5 xl:order-2 xl:grid-rows-[auto_auto_1fr]">
            ...
            <div className="relative z-10">
              ...
              <h1 className="display-title display-hero balanced-text text-on-light mt-5 max-w-[9.8ch] font-semibold sm:mt-6 xl:max-w-[12ch] xl:text-[3.85rem] xl:leading-[0.92] 2xl:text-[4.35rem]">
                Estate living shaped by calm, order, and belonging.
              </h1>
              <p className="body-copy-lg text-on-light-muted mt-5 max-w-[31rem] xl:text-[1rem]">
              ...
              {supportingVisuals.map((visual) => (
                ...
                >
                  <div className="radius-inset overflow-hidden">
                    ...
                    <div className="surface-panel border-t border-[var(--color-line)] px-4 py-4 sm:px-5">
            ...
            {featuredNotice ? (
              <article className="soft-card surface-dark radius-feature px-6 py-6 sm:px-7">
                <div className="grid gap-5 lg:grid-cols-[auto_1fr] lg:gap-8">
                  ...
                  <div>
                    <h2 className="text-[1.65rem] leading-[1.04] font-medium text-on-dark xl:text-[1.9rem]">
